...
const s = { strokeWidth: 1.5, fill: "none", stroke: "currentColor", strokeLinecap: "round" as const, strokeLinejoin: "round" as const };
...
export function Circuit({ className }: Props) {
  return (
    <svg className={className} viewBox="0 0 24 24" {...s}>
...
export function Gear({ className }: Props) {
  return (
    <svg className={className} viewBox="0 0 24 24" {...s}>
...
export function Quote({ className }: Props) {
  return (
...
export function ArrowRight({ className }: Props) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="currentColor">
      <path fillRule="evenodd" d="M8.22 2.97a.75.75 0 011.06 0l4.5 4.5a.75.75 0 010 1.06l-4.5 4.5a.75.75 0 01-1.06-1.06l3.22-3.22H3.25a.75.75 0 010-1.5h8.19L8.22 4.03a.75.75 0 010-1.06z" clipRule="evenodd" />
    </svg>
  );
}
...
export function Trending({ className }: Props) {
  return (
    <svg className={className} viewBox="0 0 24 24" {...s}>
